{ lib, pkgs, stdenv, buildPythonApplication, pythonPackages, fetchurl, fetchFromGitHub, psycopg2 ? null }:
let
...
buildPythonApplication rec {
  ...
  propagatedBuildInputs = with pythonPackages; [
    ...
    matrix-angular-sdk bleach netaddr jinja2
  ] ++ lib.optional (psycopg2 != null) psycopg2;
